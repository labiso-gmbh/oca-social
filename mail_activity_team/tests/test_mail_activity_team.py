...
class TestMailActivityTeam(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.partner_client, cls.partner_client_2 = cls.env["res.partner"].create(
    ...
    def test_missing_activities(self):
        ...
        self.assertEqual(self.team1.count_missing_activities, 2)
    ...
    def test_my_activity_date_deadline(self):
        ...
        self.assertEqual(partner, self.partner_client | self.partner_client_2)
        self.assertEqual(partner.mapped("my_activity_date_deadline"), [today, today])
